...
test "disassemble" {
    ...
    var disassembler = Disassembler.init(&.{
        ...
        0x40, 0x8A, 0x34, 0x08,
        0xFF, 0x81, 0xC8, 0x16, 0x00, 0x00,
        0x48, 0xFF, 0x81, 0x00, 0x07, 0x00, 0x00,
        0x66, 0xFF, 0x81, 0x00, 0x01, 0x00, 0x00,
        0xFE, 0x41, 0x10,
        0x48, 0xFF, 0xC3,
        0xFF, 0xC0,
        0x66, 0xFF, 0xC0,
    ...
    try testing.expectEqualStrings(
        ...
        \\inc dword ptr [rcx + 0x16c8]
        \\inc qword ptr [rcx + 0x700]
        \\inc word ptr [rcx + 0x100]
        \\inc byte ptr [rcx + 0x10]
        \\inc rbx
        \\inc eax
        \\inc ax
        \\dec eax
